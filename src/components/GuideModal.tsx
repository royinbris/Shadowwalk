    ...
    <div className="fixed inset-0 z-[9999] flex flex-col bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-200 overflow-hidden animate-in fade-in duration-200 h-[100dvh]">
      ...
      <div className="flex-none flex items-center justify-between p-4 border-b border-zinc-200 dark:border-zinc-800 bg-white/80 dark:bg-zinc-900/50 backdrop-blur-md no-print">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-xl font-black uppercase tracking-widest text-zinc-900 dark:text-zinc-100">User Guide & Tips</h2>
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-8 lg:px-24 xl:px-48 custom-print-area">
        <div className="max-w-4xl mx-auto space-y-12 pb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Core Features */}
            <section className="space-y-6 bg-white dark:bg-zinc-900/30 p-6 rounded-2xl border border-zinc-200 dark:border-zinc-800/50 shadow-sm dark:shadow-none">
              <div className="flex items-center gap-3 border-b border-zinc-200 dark:border-zinc-800 pb-4">
                <Settings className="w-5 h-5 text-purple-400" />
                <h3 className="text-xl font-bold uppercase tracking-widest text-zinc-900 dark:text-zinc-100">기본 조작법 (Gestures)</h3>
              </div>
              <ul className="space-y-4 text-zinc-700 dark:text-zinc-300">
                <li className="flex items-start gap-3">
                  <div className="mt-1 w-1.5 h-1.5 rounded-full bg-blue-500 shrink-0" />
                  <div>
                    <strong className="text-zinc-900 dark:text-zinc-100 block mb-0.5">화면 중앙 터치 (1번)</strong>
                    영상을 재생하거나 일시정지합니다.
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="mt-1 w-1.5 h-1.5 rounded-full bg-blue-500 shrink-0" />
                  <div>
                    <strong className="text-zinc-900 dark:text-zinc-100 block mb-0.5">화면 좌/우 터치 (1번)</strong>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <strong className="text-zinc-900 dark:text-zinc-100 block mb-0.5">화면 중앙 터치 (2번 연속)</strong>
                ...
                <li className="flex items-start gap-3">
                  <div className="mt-1 w-1.5 h-1.5 rounded-full bg-emerald-500 shrink-0" />
                  <div>
                    <strong className="text-zinc-900 dark:text-zinc-100 block mb-0.5">화면 좌/우 터치 (2번 연속)</strong>
            ...
            <section className="space-y-6 bg-white dark:bg-zinc-900/30 p-6 rounded-2xl border border-zinc-200 dark:border-zinc-800/50 shadow-sm dark:shadow-none">
              <div className="flex items-center gap-3 border-b border-zinc-200 dark:border-zinc-800 pb-4">
                ...
                <h3 className="text-xl font-bold uppercase tracking-widest text-zinc-900 dark:text-zinc-100">핵심 학습 기능</h3>
              </div>
              <ul className="space-y-4 text-zinc-700 dark:text-zinc-300">
                <li className="flex items-start gap-3">
                  <div className="mt-1 w-1.5 h-1.5 rounded-full bg-orange-500 shrink-0" />
                  <div>
                    <strong className="text-zinc-900 dark:text-zinc-100 block mb-0.5">Auto-Pause (자동 일시정지)</strong>
                ...
                <li className="flex items-start gap-3">
                  <div className="mt-1 w-1.5 h-1.5 rounded-full bg-orange-500 shrink-0" />
                  <div>
                    <strong className="text-zinc-900 dark:text-zinc-100 block mb-0.5">Loop (구간 반복)</strong>
                ...
                <li className="flex items-start gap-3">
                  <div className="mt-1 w-1.5 h-1.5 rounded-full bg-orange-500 shrink-0" />
                  <div>
                    <strong className="text-zinc-900 dark:text-zinc-100 block mb-0.5">Sync (싱크 조절)</strong>
          ...
          {/* Shadowing Tips */}
          <section className="space-y-6 mt-12 bg-blue-50 dark:bg-blue-950/20 p-8 rounded-3xl border border-blue-200 dark:border-blue-900/30 relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-8">
              ...
              <div className="space-y-8 text-zinc-700 dark:text-zinc-300">
                <div className="bg-white/80 dark:bg-black/20 p-6 rounded-2xl border border-zinc-200 dark:border-blue-500/10 shadow-sm dark:shadow-none">
                ...
                <div className="bg-white/80 dark:bg-black/20 p-6 rounded-2xl border border-zinc-200 dark:border-emerald-500/10 shadow-sm dark:shadow-none">
                  <h4 className="text-lg font-bold text-zinc-900 dark:text-white mb-2 flex items-center gap-2">
                ...
                <div className="bg-white/80 dark:bg-black/20 p-6 rounded-2xl border border-zinc-200 dark:border-orange-500/10 shadow-sm dark:shadow-none">
                  <h4 className="text-lg font-bold text-zinc-900 dark:text-white mb-2 flex items-center gap-2">
                ...
                <div className="bg-white/80 dark:bg-black/20 p-6 rounded-2xl border border-zinc-200 dark:border-purple-500/10 shadow-sm dark:shadow-none">
                  <h4 className="text-lg font-bold text-zinc-900 dark:text-white mb-2 flex items-center gap-2">
