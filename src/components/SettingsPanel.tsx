...
import { HelpCircle, RotateCcw, Key } from 'lucide-react';
...
export const SettingsPanel = ({
  ...
  return (
    <div className="p-4 overflow-y-auto h-full flex justify-center">
      <div className="w-full max-w-lg space-y-6">
        ...
        <div className="space-y-4 pb-4">
          <div className="flex gap-4 items-start">
            ...
            <div className="w-[80px] flex flex-col gap-1.5 pt-1 border-l border-zinc-700/50 pl-2 shrink-0">
              <button 
                onClick={() => {
