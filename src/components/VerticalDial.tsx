  ...
  return (
    <div className="flex flex-col items-center gap-1.5">
      ...
      <div className="flex flex-col items-center gap-1.5">
        ...
        <div 
          className="w-9 h-[180px] bg-zinc-950 rounded-full border border-zinc-800/50 relative cursor-ns-resize shadow-[inset_0_2px_8px_rgba(0,0,0,0.8)] touch-none overflow-hidden"
          onWheel={(e) => {
